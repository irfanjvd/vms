...
var yadcf = (function ($) {
	...
	function addRangeDateFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, date_format) {
		...
		$(filter_selector_string).append("<p style='text-align:left;'>"+filter_default_label+"</p><input onkeydown=\"yadcf.preventDefaultForEnter(event);\" placeholder=\"" + 'From' + "\" id=\"" + fromId + "\" class=\"yadcf-filter-range-date yadcf-filter-range\" " + filterActionStr + "></input>");
			...
			if (args.hasOwnProperty(columnObjKey)) {
				...
				if ($filter_selector.length === 1) {
					...
					if (columnObj.filter_type === "select" || columnObj.filter_type === 'custom_func') {
						...
						$(filter_selector_string).append("<p style='text-align:left;'>"+filter_default_label+"</p><input onkeydown=\"yadcf.preventDefaultForEnter(event);\" id=\"yadcf-filter-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"yadcf-filter\" onmousedown=\"yadcf.stopPropagation(event);\" onclick='yadcf.stopPropagation(event);"

...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function _fnGetColumnValues(oSettings, iColumn, bUnique, bFiltered, bIgnoreEmpty) {
            ...
            for (var i = 0, c = aiRows.length; i < c; i++) {
                ...
                // ignore unique values?
                    ...
                    == true && jQuery.inArray(sValue, asResultData) > -1) continue;
        ...
        function fnCreateDateRangeInput(oTable) {
            date_range_value=label.replace(/(^\s*)|(\s*$)/g, "");
            var aoFragments = sRangeFormat.split(/[}{]/);
            th.html("");
            //th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input style="width:100px;float:left" type="text" class="date_range_filter form-control" placeholder="'+date_range_value+'" id="' + sFromId + '" rel="' + i + '"/>');
            ...
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input style="width:100px;float:left" type="text" class="date_range_filter form-control" placeholder="'+date_range_value+'" id="' + sToId + '" rel="' + i + '"/>');
            //th.append(to);
            //th.append(_fnRangeLabelPart(2));
        ...
        var defaults = {
            ...
            iFilteringDelay: 500,
            aoColumns: null,
            sRangeFormat: "<span style='float:left;padding:10px;'>From</span> {from} <span style='float:left;padding:10px;'>to</span> {to}",
            sDateFromToken: "from",
            sDateToToken: "to"
        };

        ...
        <div class="col-md-12"> 
          ...
          <section class="tile"> 
            ...
            <div class="tile-header dvd dvd-btm">
              <h1 class="custom-font"><strong>Reservations</strong>Listing</h1>
            ...
            <div class="tile-body table-custom">
              ...
              <div class="table-responsive">
                <table id="example122" class="table table-bordered table-striped listreservationtable">
                  <thead class="custom-font">
                    <tr role="row">
                      <th class="sorting" role="columnheader">CNIC</th>
                      <th class="sorting" role="columnheader">Visitro Name</th>
                      <th class="sorting" role="columnheader">Employee Name</th>
                      <th class="sorting" role="columnheader">Vehicle Type</th>
                      <th class="sorting" role="columnheader">Vehicle Number</th>
                      <th class="sorting" role="columnheader">Reservation Date</th>

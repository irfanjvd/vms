      ...
      <div class="pageheader">
        <div class="page-bar">
          <ul class="page-breadcrumb">
            ...
            <li> <a href="#"><i class="fa fa-user" style="margin-right:6px;"></i>Add Reservation</a> </li>
          </ul>
        ...
        <div class="col-md-12"> 
          ...
          <section class="tile"> 
            ...
            <div class="tile-header dvd dvd-btm">
              <h1 class="custom-font"><strong>Add </strong>Reservation</h1>
                ...
                <form name="add_user" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            ...
                            <input type="text" class="form-control date-picker" name="reservation_date" placeholder="" value="<?php echo (isset($info['reservation_date']))? $info['reservation_date']: '' ?>">
                        </div>
                    </div>
...
<!--                            <div class="col-xs-9"></div>-->
                            <div class="col-xs-2">
                                <input type="submit" name="submit" value="Add Reservation" class="btn btn-success col-xs-12">
                            </div>

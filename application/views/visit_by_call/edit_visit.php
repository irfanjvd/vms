            ...
            <div class="col-md-12">
                ...
                <section class="tile">
                    ...
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>Edit </strong>Visit (Phone Call)</h1>
                    ...
                    ?>
                        <!--<form id="edit_visitor_form" method="post">-->
                        <?php
                        ...
                        ?>
                            <div class="row">
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <input type="text" required="required" class="form-control" name="caller_name" id="caller_name" value="<?php if(isset($member_info['employee_name'])){ echo $member_info['employee_name']; }else if(isset($member_info['name'])){ echo $member_info['name']; }; ?>">
                                </div>

                                <div class="col-xs-3">
                                    <label class="form_label">Caller Designation *:</label>
                                    <input type="text" required="required" class="form-control" name="caller_designation" id="caller_designation" value="<?php if(isset($member_info['employee_designation'])){ echo $member_info['employee_designation']; }else if(isset($member_info['name'])){ echo $member_info['name']; }; ?>">
                                </div>
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <select class="form-control" name="visit_to_tenant" id="visit_to_tenant" onchange="get_employees(value)">
                                        ...
                                        ?>
                                            <option <?php if(isset($member_info) && $member_info['employee_company']==$member_info['employee_company']){ echo "selected"; } ?> value="<?php echo $member_info['employee_company']; ?>"><?php echo $member_info['employee_company']; ?></option>
                                        <?php
                                        }
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <input type="text" required="required" class="form-control" name="visitor_name" id="visitor_name" value="<?php if(isset($member_info['visitor_name'])){ echo $member_info['visitor_name']; }else if(isset($member_info['name'])){ echo $member_info['name']; }; ?>">
                                </div>

                                <div class="col-xs-3">
                                    <label class="form_label">Visitor CNIC (Optional):</label>
                                    <input type="text" class="form-control" name="visitor_identity_no" id="visitor_identity_no" maxlength="13" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php if(isset($member_info['visitor_identity_no'])){ echo $member_info['visitor_identity_no']; }else if(isset($member_info['name'])){ echo $member_info['name']; }; ?>">
                                </div>
                                
                                <div class="col-xs-6">
                                  <label class="form_label">Reason for Visit:</label>
                                  <textarea name="visit_reason" class="form-control" value="<?php if(isset($member_info['visit_reason'])){ echo $member_info['visit_reason']; }?>" style="width:100%; height:100px; border-bottom:" ></textarea>
                                </div>

                                <div class="col-xs-3 checkout" >
                                    <label class="form_label">Check In Time:</label>
                                    <input type="text"  class="form-control checkin_by_call_datepicker" name="visit_checkin" id="visit_checkin">
                                </div>
...
$( document ).ready(function() {
    ...
    { 
    sideBySide:true,
    defaultDate: "<?php echo $member_info['visit_date'];?>",
    minDate:new Date(),
    widgetPositioning: {
    horizontal: 'left',
    vertical: 'bottom'

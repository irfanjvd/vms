      ...
      <div class="pageheader">
        <div class="page-bar">
          <ul class="page-breadcrumb">
            ...
            <li> <a href="#"><i class="fa fa-user" style="margin-right:6px;"></i>Edit Tenant Employee</a> </li>
          </ul>
                        ...
                        <div class="col-xs-4">
                            ...
                            <select name="tenant_name" class="form-control">
                                ...
                                foreach($tenants as $key=>$val){
                                    ?>
                                    <option <?php if($info['tenant_name']==$val['tenant_name']){ echo "selected"; } ?> value="<?php echo $val['id'].'_'.$val['tenant_name']; ?>"><?php echo $val['tenant_name']; ?></option>
                                <?php
                                }
...
<!--                            <div class="col-xs-9"></div>-->
                            <div class="col-xs-2">
                                <input type="submit" name="submit" value="Update Tenant Employee" class="btn btn-success col-xs-12">

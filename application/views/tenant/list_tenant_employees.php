        ...
        <div class="col-md-12"> 
          ...
          <section class="tile"> 
            ...
            <div class="tile-header dvd dvd-btm">
              <h1 class="custom-font"><strong>Tenant Employees</strong>Listing</h1>
            ...
            <div class="tile-body table-custom">
              ...
              <div class="table-responsive">
                <table id="example122" class="table table-bordered table-striped listtenantemployeetable">
                  <thead class="custom-font">
                    <tr role="row">
                      <th class="sorting" role="columnheader">Tenant</th>
                      <th class="sorting" role="columnheader">Employee</th>
                      <th class="sorting" role="columnheader">Mobile Number</th>
<!--                      <th class="sorting" role="columnheader">Created Date</th>-->
<!--                      <th class="sorting" role="columnheader">Issue Card</th>-->

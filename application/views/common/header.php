...
<div id="wrap" class="animsition">
    ...
    <section id="header" class="scheme-black">
        <header class="clearfix">
            ...
            <!-- Branding -->
            <div class="branding scheme-black"><a class="brand" href="<?php echo base_url(); ?>">
                    <span><strong>VMS - </strong>Visitor Management System</span> </a> <a href="#"
                                                                                          class="offcanvas-toggle visible-xs-inline"><i
...
<!--                        </span>-->
                    ...
                    <ul class="dropdown-menu animated littleFadeInRight" role="menu">
                        ...
                        if ($session_data['login_user_type'] != "TENANT") {
                            ?>
                            <li>
                                <a href="<?php echo base_url() . "user/edit_user/" . $session_data['login_user_id']; ?>">
                        ...
                        ?>
                        <li><a href="<?php echo base_url() . 'user/logout'; ?>"> <i class="fa fa-sign-out"></i>Logout
                            </a></li>
                    </ul>
                </li>
            </ul>
                    ...
                    <div class="panel-group slim-scroll" role="tablist">
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title"><a data-toggle="collapse" href="#sidebarNav"> Navigation <i
                                ...
                                <div class="panel-body">
                                    ...
                                    <ul id="navigation">
                                        <?php if ($session_data['login_user_type'] == "SUPER") { ?>
                                            <li><a href="<?= base_url() ?>visitor/index"><i class="fa fa-dashboard"></i>
                                                    <span>Dashboard</span></a></li>
                                            <li><a href="#"><i class="fa fa-group"></i> <span>Users</span> </a>
                                                <ul>
                                                    <li>
                                                        <a href="<?= base_url() ?>user/add_user"><i
                                                                    class="fa fa-user"></i> Add User</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?= base_url() ?>user/list_users"><i
                                                                    class="fa fa-user"></i> List Users</a>
                                                    </li>
                                                    <!-- <li>
                                            ...
                                            <li><a href="#"><i class="fa fa-group"></i> <span>Visit Types</span> </a>
                                                <ul>
                                                    <li>
                                                        <a href="<?= base_url() ?>Visit_Types/adding"><i
                                                                    class="fa fa-user"></i> Add</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?= base_url() ?>Visit_Types/listing"><i
                                                                    class="fa fa-user"></i> List</a>
                                                    </li>
                                            ...
                                            <li><a href="#"><i class="fa fa-group"></i> <span>Visit Gates</span> </a>
                                                <ul>
                                                    <li>
                                                        <a href="<?= base_url() ?>Visit_Gates/adding"><i
                                                                    class="fa fa-user"></i> Add</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?= base_url() ?>Visit_Gates/listing"><i
                                                                    class="fa fa-user"></i> List</a>
                                                    </li>
                                            ...
                                            <li><a href="#"><i class="fa fa-group"></i> <span>Black listed</span> </a>
                                                <ul>
                                                    <li>
                                                        <a href="<?= base_url() ?>blacklisted/listing"><i
                                                                    class="fa fa-user"></i> List</a>
                                                    </li>
                                        ...
                                        <?php if ($session_data['login_user_type'] == "TENANT" || $session_data['login_user_type'] == "NORMAL") { ?>
                                            <li><a href="<?= base_url() ?>visitor/addvisitor"><i class="fa fa-user"></i>
                                                    Add Visits</a></li>
                                            <li>
                                                <a href="<?php echo base_url() ?>visit/visits"><i
                                                            class="fa fa-user"></i>Visit Details</a>
                                        ...
                                        <!-- <li>
                                                <a href="<?php // base_url()
                                        ?>visit/visits"><i class="fa fa-user"></i>Visit Details</a>

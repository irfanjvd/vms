        ...
        <div class="pageheader">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li><a href="#"><i class="fa fa-pencil-square" style="margin-right:6px;"></i>Update Visit Type</a>
                    </li>
                </ul>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <?php foreach ($record as $rec) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><input type='text' name='form_name' value='<?php echo $rec->name; ?>'
                                               class='form-control' placeholder='form_name'></td>
                                </tr>


                            <?php } ?></tbody>
                        </table>
                        <p align='center'><input type='submit' value='Update Record' class='btn btn-primary'/>

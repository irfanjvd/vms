...
<div class="row">
	...
	<div class="col-md-6"><input type='text' name='form_name' class='form-control' placeholder='Name'></div>
</div>	
<div class="row" style="margin-top:10px;">
	<div class="col-md-2"></div>
	<div class="col-md-6"><p align='center'><input type='submit' value='Save Record' class='btn btn-primary' /> 

			...
			?>
                <!--<form name="add_private_visit" id="add_private_visit" action="" method="post" enctype="multipart/form-data">-->
                    ...
                    ?>
						...
						<div class="row">
							<div class="col-xs-2">
								<input type="button" name="submit" value="NEXT >" class="btn btn-success col-xs-12" onclick="return verify_data('add_private_visit')?add('visit_data','add_private_visit','add_private_visit'):false">
							</div>
						</div>-->	
                <!--</form>-->
				<?php
			...
			?>
                <!--<form name="add_visit_data" id="add_visit_data" action="" method="post" enctype="multipart/form-data">-->
                    ...
                    ?>
						...
						<div class="row">
							<div class="col-xs-2">
								<input type="button" name="submit" value="Add Members" class="btn btn-success col-xs-12" onclick="return verify_data('add_private_visit')?add('member_data','add_private_visit','add_members'):false">
							</div>

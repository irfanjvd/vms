      ...
      <div class="pageheader">
        <div class="page-bar">
          <ul class="page-breadcrumb">
            ...
            <li> <a href="#"><i class="fa fa-user" style="margin-right:6px;"></i>Add Location</a> </li>
          </ul>
        ...
        <div class="col-md-12"> 
          ...
          <section class="tile"> 
            ...
            <div class="tile-header dvd dvd-btm">
              <h1 class="custom-font"><strong>Add </strong>Location</h1>
                ...
                <!--<form name="add_user" action="" method="post" enctype="multipart/form-data">-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                          ...
                          <input type="text" class="form-control" name="location" placeholder="Enter Location" value="<?php echo (isset($info['location']))? $info['location']: '' ?>">
                        </div>
                        <div class="col-xs-4">
                            <label class="form_label">Issue Card:</label><br>
                            <input type="radio" class="form-controls" name="issue_card"  value="1">
                        </div>

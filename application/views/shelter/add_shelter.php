      ...
      <div class="pageheader">
        <div class="page-bar">
          <ul class="page-breadcrumb">
            ...
            <li> <a href="#"><i class="fa fa-user" style="margin-right:6px;"></i>Add Shelter</a> </li>
          </ul>
        ...
        <div class="col-md-12"> 
          ...
          <section class="tile"> 
            ...
            <div class="tile-header dvd dvd-btm">
              <h1 class="custom-font"><strong>Add </strong>Shelter</h1>
                ...
                <!--<form name="add_user" action="" method="post" enctype="multipart/form-data">-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                          ...
                          <input type="text" class="form-control" name="shelter" placeholder="Enter Shelter name" value="<?php echo (isset($info['shelter']))? $info['shelter']: '' ?>">
                        </div>
                        <div class="col-xs-4">
                          <label class="form_label">Rooms *:</label>
                          <input type="text" class="form-control" name="room" placeholder="Enter Number of Rooms" value="<?php echo (isset($info['room']))? $info['room']: '' ?>">
                        </div>
                          ...
                          <div class="row" style="margin-top:20px;">
                            ...
                            <div class="col-xs-2">
                                <input type="submit" name="submit" value="Add Location" class="btn btn-success col-xs-12">

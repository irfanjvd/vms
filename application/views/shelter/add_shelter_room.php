      ...
      <div class="pageheader">
        <div class="page-bar">
          <ul class="page-breadcrumb">
            ...
            <li> <a href="#"><i class="fa fa-user" style="margin-right:6px;"></i>Add Shelter Room</a> </li>
          </ul>
        ...
        <div class="col-md-12"> 
          ...
          <section class="tile"> 
            ...
            <div class="tile-header dvd dvd-btm">
              <h1 class="custom-font"><strong>Add </strong>Shelter Room</h1>
                ...
                <!--<form name="add_user" action="" method="post" enctype="multipart/form-data">-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                          ...
                          <input type="text" class="form-control" name="capacity" placeholder="Enter Room Capacity" value="<?php echo (isset($info['capacity']))? $info['capacity']: '' ?>">
                        </div>
                          ...
                          <div class="row" style="margin-top:20px;">
                            ...
                            <div class="col-xs-2">
                                <input type="submit" name="submit" value="Add Room" class="btn btn-success col-xs-12">

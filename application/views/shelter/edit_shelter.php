      ...
      <div class="pageheader">
        <div class="page-bar">
          <ul class="page-breadcrumb">
            ...
            <li> <a href="#"><i class="fa fa-user" style="margin-right:6px;"></i>Edit Shelter</a> </li>
          </ul>
        ...
        <div class="col-md-12"> 
          ...
          <section class="tile"> 
            ...
            <div class="tile-header dvd dvd-btm">
              <h1 class="custom-font"><strong>Edit </strong>Shelter</h1>
                ...
                <form name="add_user" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                              ...
                              <input type="text" class="form-control" name="shelter" placeholder="Shelter Name" value="<?php echo (isset($info['shelter']))? $info['shelter']: '' ?>">
                        </div>
                        <div class="col-xs-4">

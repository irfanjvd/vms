        ...
        <div class="col-md-12"> 
          ...
          <section class="tile"> 
            ...
            <div class="tile-header dvd dvd-btm">
              <h1 class="custom-font"><strong>Shelter Rooms</strong>Listing</h1>
            ...
            <div class="tile-body table-custom">
              ...
              <div class="table-responsive">
                <table id="example122" class="table table-bordered table-striped listshelterroomstable">
                  <thead class="custom-font">
                    <tr role="row">
                      <th class="sorting" role="columnheader">Shelter</th>
                      <th class="sorting" role="columnheader">Room</th>
                      <th class="sorting" role="columnheader">Capacity</th>
